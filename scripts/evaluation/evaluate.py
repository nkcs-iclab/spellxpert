...
def main(
        ...
        html_report_filter: str = 'FN',
        json_report_enabled: bool = True,
        extract_output_enabled: bool = True,
        extract_output_filter: str = 'TP | FP',
        extract_output_mode: str = 'JSONL | HUMAN_READABLE | PLAIN_TEXT',
    ...
    config.html_report.filter = eval(html_report_filter)
    config.json_report.enabled = json_report_enabled
    config.extract_output.enabled = extract_output_enabled
    config.extract_output.filter = eval(extract_output_filter)
